...
(function() {
  var Game, GameState, Player, actionHandler, addToken, checkMove, droppedTile, escape, gameState, getMove, handleAction, handleActions, handleError, hideRules, initPlayer, login, logout, myTurn, post, processTiles, register, request, selectTile, sendMove, sendPass, showRules, startPage,
  ...
  GameState = (function() {
    ...
    GameState.prototype.xRun = function(scores, b, y, x) {
      ...
      return (_ref = scores[_name = "" + y + (this.translateCol(xMin)) + "-" + (this.translateCol(xMax))]) != null ? _ref : scores[_name] = this.sum((function() {
        var _i, _results;
        _results = [];
    ...
    GameState.prototype.yRun = function(scores, b, y, x) {
      ...
      return (_ref = scores[_name = "" + (this.translateCol(x)) + yMin + "-" + yMax]) != null ? _ref : scores[_name] = this.sum((function() {
        var _i, _results;
        _results = [];
